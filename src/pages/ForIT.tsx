...
const ForIT = () => {
  useEffect(() => { document.title = "AI Adoption for CIO & Digital Transformation — The Unlearning School"; }, []);
    ...
    <>
      ...
      <Section>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          <Sidebar byline="On dashboards & reality" read="6 min" filed="IT · Measurement" />
      ...
      <Section variant="paper">
        <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-red mb-3">— Two measurement layers, not one</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-ink/10">
          <article className="bg-paper p-8 md:p-10">
            <Kicker variant="muted">— Your current dashboard measures</Kicker>
            ...
            <p className="text-sm text-ink/60 mt-6 italic font-display">Shows access and interaction. Does not show whether work changed.</p>
          </article>
          <article className="bg-ink text-paper p-8 md:p-10">
            <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-red mb-3">— What the AI Adoption Sprint measures</p>
            ...
            <ul className="space-y-3 text-paper/85 text-[15px]">
              ...
              <li className="border-b border-paper/15 pb-2">→ Where the workflow blockage is specific</li>
              <li className="border-b border-paper/15 pb-2">→ Process time delta before and after redesign</li>
      ...
      <Section bordered={false}>
        <Blockquote attribution="On the structural gap">
          The problem is not that the deployment failed. The problem is that the workflow redesign that should have followed the deployment never happened.
        </Blockquote>
      </Section>

      <Section>
        <SectionHeading
          kicker="The AI Adoption Sprint"
