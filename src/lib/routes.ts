...
export const ROUTES: { en: string; ro: string }[] = [
  ...
  { en: "/resources/eu-ai-act-article-4", ro: "/ro/resources/eu-ai-act-article-4" },
  { en: "/resources/copilot-rollout-stalls", ro: "/ro/resources/copilot-rollout-stalls" },
  { en: "/resources/lewin-model-ai-adoption", ro: "/ro/resources/lewin-model-ai-adoption" },
  { en: "/resources/ai-procurement-workflows", ro: "/ro/resources/ai-procurement-workflows" },
  { en: "/resources/vendor-mdf-ai-training", ro: "/ro/resources/vendor-mdf-ai-training" },
  { en: "/resources/hermes-vs-chatgpt", ro: "/ro/resources/hermes-vs-chatgpt" },
